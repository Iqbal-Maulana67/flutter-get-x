...
import 'package:flutter_get_x/controller/demoController.dart';
import 'package:flutter_get_x/controller/purchase.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(child: GetX<Purchase>(builder: (controller) {
                    ...
                    Padding(
                      ...
                      child: ElevatedButton(
                          ...
                          child: Text(
                            'Shop Now',
                            style: TextStyle(
                                fontWeight: FontWeight.normal, fontSize: 12.9),
                          )),
                    ),
                  ],
                )
